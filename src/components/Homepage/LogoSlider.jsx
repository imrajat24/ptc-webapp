...
const LogoSlider = () => {
  return (
    <section className="section-logo-slider about-partners" data-aos="fade-up">
      {/* <!-- Section-heading --> */}
      {/* <div className="section-logo-slider__heading">
        <h2>experts guiding you have been associated with</h2>
      </div> */}
      <div className="about-partners_heading ">
        <h2 className="heading-section">our associated partners</h2>
      </div>
      {/* <!-- ?Parent Flex --> */}
      {/* <!-- Container for logos --> */}
      <div className="section-logo-slider__container">
        {/* <!-- * Flex Child --> */}
        {/* <!-- Child-1 --> */}
        <div className="section-logo-slider__container__child">
          <img
          ...
          />
          <img
            src="https://res.cloudinary.com/dlghjr9qx/image/upload/v1662845979/PTC/PTC%20Website%20Work/HP_Screws_logos-removebg-preview_or0xwl.png"
            alt="logo-9"
          />
          <img
